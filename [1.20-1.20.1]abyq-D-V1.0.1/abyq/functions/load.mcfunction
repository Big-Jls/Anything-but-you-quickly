...
#设置开始时间默认为白天的0刻开始
title @a clear
title @a actionbar [{"text": "作者","color": "dark_purple"},{"text":">>>","color": "black"},{"text": "Big_Jls","color": "yellow"},{"text": "          "},{"text": "版本","color": "dark_purple"},{"text": ">>>","color": "black"},{"text": "1.0.1","color": "dark_green"}]
...
scoreboard objectives add sfr minecraft.used:minecraft.splash_potion
#冻结抵抗
